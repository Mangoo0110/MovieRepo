...
class DTabBarTheme {
  ...
  static TabBarTheme lightTabBarTheme = TabBarTheme(
    ...
    labelStyle: const TextStyle(fontSize: AppSizes.smallTextSize2, fontWeight: FontWeight.bold), // Style of the selected tab's label
    unselectedLabelStyle: const TextStyle(fontSize: AppSizes.smallTextSize2, fontWeight: FontWeight.bold), // Style of the unselected tab's label
